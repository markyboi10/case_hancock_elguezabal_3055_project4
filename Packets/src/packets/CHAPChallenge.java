...
public class CHAPChallenge implements Packet, JSONSerializable {
     ...
     * @param nonce
     */
    public CHAPChallenge(String nonce) {
        this.nonce = nonce;
    }
     ...
     */
    public CHAPChallenge(byte[] packet) throws InvalidObjectException {
        recieve(packet);
    }
    ...
    public void recieve(byte[] packet) {
        ...
        try {
            ...
            Logger.getLogger(CHAPChallenge.class.getName()).log(Level.SEVERE, null, ex);
        }
