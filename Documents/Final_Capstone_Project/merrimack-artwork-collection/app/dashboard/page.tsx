...
export default function About() {
    ...
    const handleSubmit = () => {
        ...
        fetch(`http://cs.merrimack.edu:8001/api/addArtwork`, {
            method: "POST",
            headers: {
    ...
    const handleUserSubmit = () => {
        ...
        console.log("Request Page: Before sending to nextjs api");
        console.dir(data);
        fetch(`http://cs.merrimack.edu:8001/api/editUser`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json',
    ...
    const handleArtwork = () => {
        fetch(`http://cs.merrimack.edu:8001/api/artworksList`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Cache-Control': 'no-cache, no-store, max-age=0, must-revalidate',
    ...
    const handleEdit = () => {
        ...
        fetch(`http://cs.merrimack.edu:8001/api/editArtwork`, {
            method: "PUT",
            headers: {
                'Content-Type': 'application/json',
                'Cache-Control': 'no-store',
    ...
    const handleDelete = () => {
        ...
        fetch(`http://cs.merrimack.edu:8001/api/deleteArtwork`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'Cache-Control': 'no-store',
    ...
    const handleMigrations = () => {
        ...
        fetch(`http://cs.merrimack.edu:8001/api/allMigrations`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Cache-Control': 'no-store',
    ...
    const handleApprove = (id: number | null) => {
        ...
        fetch(`http://cs.merrimack.edu:8001/api/updateMigration`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'Cache-Control': 'no-store',
