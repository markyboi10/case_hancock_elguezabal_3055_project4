...
export default function About() {
    ...
    const handleMigrationsA = () => {
        ...
        fetch('http://cs.merrimack.edu:8001/api/approvedMigrations', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Cache-Control': 'no-cache, no-store, max-age=0, must-revalidate',
    ...
    const handleComplete = (id: number | null, location: string, idArtwork: number | null) => {
        ...
        fetch('http://cs.merrimack.edu:8001/api/completeMigration', {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'Cache-Control': 'no-cache, no-store, max-age=0, must-revalidate',
                        ...
                        <Container px='lg' size='sm'>
                            ...
                            <form>
                                ...
                                <Container py="xl">
                                    ...
                                    <SimpleGrid cols={{ base: 1, sm: 1 }}>{approvedCards}</SimpleGrid>
                                </Container>
                            </form>
