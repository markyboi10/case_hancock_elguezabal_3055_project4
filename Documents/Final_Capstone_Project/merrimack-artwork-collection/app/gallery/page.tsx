...
export default function Gallery() {
    ...
    const handleSearch = (searchValue: string) => {
        ...
        fetch(`http://cs.merrimack.edu:8001/api/search`, {
            method: 'POST',
            headers: {
    ...
    const handleCards = (num_artworks: number) => {
        ...
        fetch(`http://cs.merrimack.edu:8001/api/artworks`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            ...
            case 'success':
                return artworkData.data.map((artwork: Artwork) => (
                    <Card key={artwork.idartwork} p="md" radius="md" component="a" href="#" className={classes.card} >
                        ...
                        <Text className={classes.title} mt={5}>
                            {"Artist Name: " + (artwork.artist && artwork.artist.artist_name !== "null" ? artwork.artist.artist_name : '-')}
                        </Text>
                        <Text className={classes.title} mt={5}>
