...
export default function Layout({
    ...
    useEffect(() => {
        ...
        fetch(`http://cs.merrimack.edu:8001/api/user`, {
            method: 'POST',
            headers: {
        ...
        fetch(`http://cs.merrimack.edu:8001/api/artworksListFiltered`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
        ...
        fetch(`http://cs.merrimack.edu:8001/api/findrequest`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Cache-Control': 'no-store',
                ...
                <Container size="md">
                    <div className={classes.inner}>
                        <Link legacyBehavior href="/">
                            <a>
                                <img src="/mchorizontalcmykeps.svg" alt="Merrimack Logo" width={150} />
                            </a>
                        </Link>
